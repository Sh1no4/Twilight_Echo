...
:global(html[data-te-equalizer-panel] .dsp-rack-page .rack-layout) {
  overflow: hidden;
...
:global(html[data-te-equalizer-panel='tinted'] .dsp-rack-page .rack-layout),
...
:global(html[data-te-equalizer-panel='glass'] .dsp-rack-page .rack-layout),
