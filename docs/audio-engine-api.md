...
| ASIO | Windows x64 | 独立兼容层；默认运行时关闭，等待 ABI 与硬件门禁 | mock 覆盖 Int16/Int24/Int24-in32/Int32/Float32；真实设备 smoke opt-in |
